				...
				<div class="container">
					<div class="row">
							...
							<div class="contact-address text-capitalize">
								<h2>Nysc Portal registration field*</h2>
								<p>register via the form</p>
							
							</div> <!-- /.contact-address -->
						</div>
						<div class="col-lg-7 col-12">
							<div class="contact-us-form">
								<form  class="form-validation form-styl-two" id="wuser-register" action="user-validity.php" method="POST">
							...
							<?php endif ?>
							<?php if (isset($_GET['email-f'])): ?>
								<div class="col-sm-12 col-12"><div class='alert text-center alert-danger alert-dismissible'>
								<button class='close' data-dismiss='alert'>&times</button>
								<span><strong class="" id="msgpop">email already exists</strong></span></div> 
								</div>
							<?php endif ?>
							<?php if (isset($_GET['mis-match'])): ?>
								<div class="col-sm-12 col-12"><div class='alert text-center alert-danger alert-dismissible'>
								<button class='close' data-dismiss='alert'>&times</button>
								<span><strong class="" id="msgpop">password donot match!</strong></span></div> 
								</div>
							<?php endif ?>
										<div class="col-sm-9 col-12"><input type="text" placeholder="First Name*" name="firstname"></div>
										<div class="col-sm-9 col-12"><input type="text" placeholder="Last Name*" name="lastname"></div>
										<div class="col-sm-9 col-12"><input type="email" placeholder="Email Address*" name="email"></div>
										<div class="col-sm-9 col-12"><input type="password" placeholder="password*" name="password"></div>
										<div class="col-sm-9 col-12"><input type="password" placeholder="repeat password*" name="c-password"></div>
									

									
									
									<input type="submit" class="ml-3" id="register-userw" name="registers" value="register">
								</form>
							</div> <!-- /.contact-us-form -->
						</div> <!-- /.col- -->
						 <!-- /.col- -->
