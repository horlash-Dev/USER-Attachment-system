			...
			-->
				...
				<div class="container">
					<div class="row">
						...
						<?php 
                         foreach ($users->blogs as $key) {   ?>
							<div class="blog-post">
								<div class="date"><?php echo date('D M Y, h:i:a', strtotime($key['created_at'])) ?></div>
								<h5 class="title"><a href="show.php?post=<?php echo $key['slug']; ?>"><?php echo $key['title'] ?></a></h5>
								<p><?php echo substr($key['body'],0, 200)."...";?></p>
								<a href="show.php?post=<?php echo $key['slug']; ?>"  class="read-more">Read More</a>
							</div> <!-- /.blog-post -->
							<?php } ?>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-8 col-12 blog-sidebar">
                         ...
                         foreach ($users->blogs as $key) {   ?>
									<li>
										<a href="show.php?post=<?php echo $key['slug']; ?>"><?php echo $key['title'] ?></a>
									</li>
											<?php } ?>
								</ul>
