				...
				<div class="container">
					...
					<div class="details-text">
						...
						<div class="col-lg-12 col-md-6 col-sm-8 col-12 portfolio-info-list">
								<ul>
                                <?php if($users->details['user_approved'] != 1): ?>
                                <div class="col-sm-12 text-center col-12"><div class='p-5 alert alert-danger'>
								<span><strong class="" id="msgpop">Dear  user : <br> <span class="m-2">You are yet to be Approved.</span></strong></span></div> 
                                </div>
                                <?php endif ?>
                                    <li class="text-center"><strong>No result found.</strong></li>    
                                </ul>
