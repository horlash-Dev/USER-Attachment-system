                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="card">
                        <form action="../user-validity.php" method="post" class="form">
                            <h4 class="card-title m-4 text-center text-capitalize">Edit Post <br> <span>
                                <?php echo $admin->details_edit_blog['title'] ?>
                            </span></span></h4>
                            <div class="card-body">
                                    
                            <div class="form-group">
                            <label for="input">Title</label>
                                <input type="text" class="form-control" required placeholder="Title*" name="title" value="<?php echo $admin->details_edit_blog['title'] ?>">
                            </div> 
                               <input type="hidden" class="form-control" name="ids" value="<?php echo $admin->details_edit_blog['id'] ?>">
                            <div class="form-group">
                            <label for="input">Body</label>
                            <textarea required style="resize: none" class="form-control" name="body" placeholder="write an artlce.."  rows="20"><?php echo $admin->details_edit_blog['body'] ?></textarea>

                            </div> 
                            
                            <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" name="p_blog_update" class="btn btn-primary">Update</button>
                                    </div>
                                </div>
                            </div>
                        </form>
