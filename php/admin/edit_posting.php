                ...
                <?php if (isset($_GET['emptyField'])): ?>
                    ...
                    <div class="card">
                        <form action="../user-validity.php" method="post" class="form">
                            <h4 class="card-title m-4 text-center text-capitalize">modify posting form</h4>
                            <div class="card-body">
                                    
                            <div class="form-group">
                            <label for="input">Name</label>
                                <input type="text" class="form-control" required placeholder="Name*" name="name" value="<?php echo $admin->details_post['name'] ?>">
                            </div>
                            <div class="form-group">
                            <label for="input">Area Posted</label>
                            <textarea class="form-control" required placeholder="Area Posted*" name="area_posted"  id="" cols="20" rows="4"><?php echo $admin->details_post['area_posted']; ?></textarea>
                            </div>
                            <div class="form-group">
                            <label for="input">LGA</label>
                                <input type="text" class="form-control" required placeholder="lga*" name="lga" value="<?php echo $admin->details_post['lga'] ?>">
                            </div>
                            <div class="form-group">
                            <label for="input">State</label>
                                <input type="text" class="form-control" required placeholder="state*" name="state" value="<?php echo $admin->details_post['state'] ?>">
                            </div>
                            <input type="hidden" value="<?php echo $admin->details_post['email'] ?>" name="a_email">
                                
                            </div>
                            <div class="border-top">
                                    <div class="card-body">
                                        <button onclick="confirm('are you sure ?')" type="submit" name="posting_edit_user" class="btn btn-primary">Modify Post</button>
                                    </div>
                                </div>
                            </div>
