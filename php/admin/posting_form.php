                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="card">
                        <form action="../user-validity.php" method="post" class="form">
                            <h4 class="card-title m-4 text-center text-capitalize">generate posting form</h4>
                            <div class="card-body">
                                    
                            <div class="form-group">
                            <label for="input">Name</label>
                                <input type="text" class="form-control" required placeholder="Name*" name="name" value="<?php echo $admin->user_details['fullname']; ?>">
                            </div>
                            <div class="form-group">
                            <label for="input">Callup Number</label>
                            <input type="text" class="form-control"required name="callup_no" value="<?php echo 'NYSC/21/'.bin2hex(random_bytes(4)); ?>">   
                        </div>
                            <div class="form-group">
                            <label for="input">Area Posted</label>
                            <textarea class="form-control" placeholder="Area Posted*" required name="area_posted" id="" cols="30" rows="10"></textarea>
   
                        </div>
                            <div class="form-group">
                            <label for="input">LGA</label>
                                <input type="text" class="form-control" required placeholder="lga*" name="lga" value="">
                            </div>
                            <div class="form-group">
                            <label for="input">State</label>
                                <input type="text" class="form-control" required placeholder="state*" name="state" value="">
                            </div>
                            <input type="hidden" value="<?php echo $admin->user_details['user_email']; ?>" name="a_email">
                                
                            </div>
                            <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" name="posting_user" class="btn btn-primary">Apply Post</button>
                                    </div>
                                </div>
                            </div>
                        </form>
