    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="dashboard.php" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard</span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="reply.php" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Queries</span></a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
				...
				<div class="">
					<div class="">
                        <div><h3 class="text-center m-2">Total verified users</h3></div>
             ...
             <table class="table table-bordered">
                                ...
                                <?php 
                         foreach ($admin->details_users as $key) {   ?>

									<tr>
										<td><?php echo $key['fullname'];?></td>
										<td><?php echo $key['user_email'];?></td>
										 <td>
                                             <?php  if($key['user_approved'] != 1): ?>
                                            <form action="../user-validity.php" method="post">
                                        <input type="hidden" name="v_mail" value="<?php echo $key['user_email'];?>"  id="">
                                        <input type="submit" value="approve" name="u-approved" class="btn btn-primary btn-sm m-1" >
                                        </form>
                                        <?php  endif; ?>  
                                        <?php  if($key['user_approved'] == 1 && $key['user_posted'] == 0): ?>
                                        <a href="posting_form.php?email=<?php echo $key['user_email'] ?>"  class="btn btn-success btn-sm m-1">Generate Posting</a>
                                        <?php elseif($key['user_posted'] == 1): ?>  
                                        <a href="edit_posting.php?email=<?php echo $key['user_email'] ?>"  class="btn btn-info btn-sm m-1">View Posting</a>
                                        <?php  endif; ?> 
                                        <a href="details.php?email=<?php echo $key['user_email'] ?>"  class="btn btn-success btn-sm m-1">view details</a>
