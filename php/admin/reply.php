    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
				...
				<div class="">
					<div class="">
                        <div><h3 class="text-center m-2">Total complained received</h3></div>
             ...
             <table class="table table-bordered">
                                ...
                                <?php 
                         foreach ($admin->admin_reply_info() as $key) {   ?>

									<tr>
										<td><?php echo $key['complain'];?></td>
										<td><?php echo $key['email'];?></td>
										<td>
                                        <form action="../user-validity.php" method="post">
                                        <input type="hidden" name="q_mail" value="<?php echo $key['email'];?>"  id="">
                                        <input type="submit" value="solve" name="q-approved" class="btn btn-primary btn-sm m-1" >
                                        </form>
                                        </td>
                                        <td>
                                        <?php  if($key['status'] != 1): ?>
