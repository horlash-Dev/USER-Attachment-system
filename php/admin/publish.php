                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="card">
                        ...
                        <form action="../user-validity.php" method="post" class="form">
                            <h4 class="card-title m-4 text-center text-capitalize">Create New Post</h4>
                            <div class="card-body">
                                    
                            <div class="form-group">
                            <label for="input">Title</label>
                                <input type="text" class="form-control" required placeholder="Title*" name="title" value="">
                            </div> 
                            
                            <div class="form-group">
                            <label for="input">Body</label>
                            <textarea required style="resize: none" class="form-control" name="body" placeholder="write an artlce.."  rows="20"></textarea>

                            </div> 
                            
                            <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" name="p_blog" class="btn btn-primary">Publish</button>
                                    </div>
                                </div>
                            </div>
                        </form>
