        ...
        <div class="table-content">
             ...
             <table class="table table-bordered">
								...
								<thead class="table-light text-left">
									...
									<tr>
                                        <td><?php echo $admin->user_details['user_email']; ?>  </td>
                                        <td><?php echo $admin->user_details['fullname']; ?>  </td>
                                        <td><?php echo $admin->user_details['marital_status']; ?>  </td>
                                        <td><?php echo $admin->user_details['matric_no']; ?>  </td>
                                        <td><?php echo $admin->user_details['callup_no']; ?>  </td>
                                        <td><?php echo $admin->user_details['state_of_origin']; ?>  </td>
                                        <td><?php echo $admin->user_details['lga']; ?>  </td>
                                        <td><?php echo $admin->user_details['address']; ?>  </td>
                                        <td><?php echo $admin->user_details['phone_no']; ?>  </td>
                                        <td><?php echo $admin->user_details['religion']; ?>  </td>
                                        <td><?php echo $admin->user_details['dob']; ?>  </td>
                                        <td><?php echo $admin->user_details['age']; ?>  </td>
                                        <td><?php echo $admin->user_details['sex']; ?>  </td>
                                        <td><?php echo $admin->user_details['nationality']; ?>  </td>
                                        <td><?php echo $admin->user_details['health_status']; ?>  </td>
                                        <td><?php echo $admin->user_details['ex_activities']; ?>  </td>
                                        <td><?php echo $admin->user_details['qualification']; ?>  </td>
                                        <td><?php echo $admin->user_details['institution']; ?>  </td>
                                        <td><?php echo $admin->user_details['service_year']; ?>  </td>
                                        <td><?php echo $admin->user_details['state']; ?>  </td>
                                        <td><?php echo $admin->user_details['dept']; ?>  </td>
                                        <td><?php echo $admin->user_details['approval_date']; ?>  </td>
                                    </tr>
