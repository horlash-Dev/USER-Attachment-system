					...
					<div class="details-text">
						...
						<div class="col-lg-12 col-md-6 col-sm-8 col-12 portfolio-info-list">
								<ul>
                                    ...
                                    <h3 class="text-uppercase">make a complain</h3><br>
                                    <input type="hidden" name="c_mail" value="<?php echo $users->details['user_email'];  ?>">
                                    <textarea name="complain_text" required id="" cols="30" rows="10" placeholder="make a complain"></textarea>
                                    <input type="submit" class="ml-3" name="complain" id="outbrebtn" value="Send">
